...
export const el: Messages = {
  ...
  'a11y.runInProgress': 'Τρέξιμο σε εξέλιξη',
  ...
  'app.decisionLocked': 'Διάλεξε Αποθήκευση ή Διαγραφή για να συνεχίσεις',
  'app.runDiscarded': 'Το τρέξιμο απορρίφθηκε — πολύ σύντομο για να κρατηθεί.',
  ...
  'history.group.byLabel': 'Ομαδοποίηση',
  'history.filter.typeLabel': 'Τύπος',
  'history.filter.more': '+ Φίλτρα',
  'history.filter.less': 'Λιγότερα',
  ...
  'chart.peakShare': '{percent}% του μέγιστου στην κορύφωση',
  'chart.peakLabel': 'κορύφωση',
  ...
  // --- Run screen -----------------------------------------------------------
  /*
   * The tightest chrome in the app. The live status pill, the sensor chips and
   * the START face all sit in fixed-width furniture, so several of these are
   * shorter than a faithful translation would be — «Σε κίνηση» rather than
   * «Βρίσκεσαι σε κίνηση», «Χωρίς GPS» rather than «Δεν υπάρχει σήμα GPS».
   */
  'gps.ready': 'Έτοιμο',
  'gps.finding': 'Αναζήτηση σήματος…',
  'gps.denied': 'Δεν δόθηκε άδεια',
  'gps.unavailable': 'Μη διαθέσιμο',
  'gps.error': 'Σφάλμα',
  'gps.idle': 'Σε αδράνεια',

  'run.newRun': 'Νέο τρέξιμο',
  'run.localOnly': 'Μόνο τοπικά · τα δεδομένα μένουν σε αυτή τη συσκευή',
  'run.outdoorHint': 'Το GPS καταγράφει διαδρομή, απόσταση και ρυθμό.',
  'run.treadmillHint': 'Αισθητήρας ποδιού, μέτρηση βημάτων ή γράψε την απόσταση της κονσόλας.',
  'run.readyWhenYouAre': 'Όποτε είσαι έτοιμος',
  'run.start': 'ΞΕΚΙΝΑ',
  'run.go': 'GO',
  'run.armSensors': 'Ενεργοποίηση αισθητήρων',
  'run.tapToArm': 'Πάτα για ενεργοποίηση',
  'run.getReady': 'Ετοιμάσου',
  'run.startClock': 'Ξεκίνα το χρονόμετρο',
  'run.startNoFix': 'Ξεκίνα χωρίς σήμα',
  'run.waitForGps': 'Ή περίμενε μέχρι το GPS να δείξει Έτοιμο.',
  'run.gpsReadyHint': 'Το GPS έχει σήμα. Όποτε είσαι έτοιμος.',
  'run.stepWarmupHint': 'Ζεσταίνεται ο μετρητής βημάτων, ή σύνδεσε αισθητήρα ποδιού παραπάνω.',
  'run.shoesMileageHint': 'Τα χιλιόμετρα προστίθενται όταν τερματίσεις το τρέξιμο.',
  'run.sensors': 'Αισθητήρες',

  'run.workout': 'Προπόνηση',
  'run.workouts': 'Προπονήσεις',
  'run.chooseWorkout': 'Διάλεξε προπόνηση',
  'run.freeRun': 'Ελεύθερο τρέξιμο',
  'run.freeRunBlurb': 'Χωρίς δομή — απλώς ξεκίνα.',
  'run.openEnded': 'Χωρίς όριο',
  'run.openGroup': 'Άνοιγμα ομάδας',
  'run.myWorkouts': 'Οι προπονήσεις μου',
  'run.myWorkoutsEmpty': 'Τίποτα αποθηκευμένο ακόμη — φτιάξε μία στα Δικά μου ιντερβάλ',
  'run.myWorkoutsSub': 'Οι αποθηκευμένες σου προπονήσεις με ιντερβάλ',
  'run.myWorkoutsHint': 'Άνοιξε τις αποθηκευμένες σου προπονήσεις.',
  'run.myWorkoutsHintEmpty': 'Αποθήκευσε εδώ δικά σου ιντερβάλ για επαναχρησιμοποίηση.',
  'run.empty': 'Άδειο',
  'run.savedCount': {
    one: '{count} αποθηκευμένη',
    other: '{count} αποθηκευμένες',
  },
  'run.workoutDeleted': 'Η προπόνηση διαγράφηκε',
  'run.workoutComplete': 'Η προπόνηση ολοκληρώθηκε',
  'run.customIntervals': 'Δικά μου ιντερβάλ',
  'run.custom.name': 'Όνομα (για αποθήκευση)',
  'run.custom.namePlaceholder': 'π.χ. Ανηφόρες Τρίτης',
  'run.custom.warm': 'Ζέσταμα (λεπτά)',
  'run.custom.cool': 'Χαλάρωμα (λεπτά)',
  'run.custom.work': 'Προσπάθεια (λεπτά)',
  'run.custom.rest': 'Ξεκούραση (λεπτά)',
  'run.custom.reps': 'Επαναλήψεις',

  'run.goal.enterTarget': 'Δώσε στόχο παραπάνω ή διάλεξε έτοιμη τιμή.',
  'run.goal.freeHint': 'Χωρίς στόχο — απλώς ξεκίνα και τρέξε. Οι θερμίδες υπολογίζονται έτσι κι αλλιώς.',
  'run.goal.targetPace': 'Ρυθμός-στόχος (προαιρετικό)',
  'run.goalReached': 'Ο στόχος πιάστηκε!',

  'run.ghostRoute': 'Διαδρομή-φάντασμα',
  'run.ghostHint': 'Γκρι μονοπάτι κάτω από τη ζωντανή σου πορεία — δεν είναι πλοήγηση βήμα προς βήμα.',
  'run.reverseDirection': 'Αντίστροφη φορά',

  'run.sensor.connected': 'Συνδέθηκε',
  'run.sensor.connecting': 'Σύνδεση…',
  'run.sensor.tap': 'Πάτα',
  'run.sensor.na': '—',
  'run.sensor.counting': 'Μετράει',
  'run.sensor.unavailable': 'Μη διαθέσιμο',
  'run.sensor.starting': 'Ξεκινάει…',
  'run.noMotion': 'Δεν υπάρχει αισθητήρας κίνησης — γράψε την απόσταση όταν τελειώσεις.',
  'run.noGps': 'Χωρίς GPS',
  'run.findingGps': 'Αναζήτηση GPS…',

  'run.moving': 'Σε κίνηση',
  'run.paused': 'Σε παύση',
  'run.autoPaused': 'Αυτόματη παύση',
  'run.finish': 'Τερματισμός',
  'run.discard': 'Απόρριψη',
  'run.confirmFinish': 'Τερματισμός αυτού του τρεξίματος;',
  'run.confirmFinishBody': 'Αποθήκευσε το τρέξιμο στο ιστορικό και σταμάτα την καταγραφή.',
  'run.confirmDiscard': 'Απόρριψη αυτού του τρεξίματος;',
  'run.confirmDiscardBody': 'Το τρέξιμο δεν θα αποθηκευτεί. Αυτό δεν αναιρείται.',

  // The treadmill arm hint no longer mentions GPS — nothing on a treadmill
  // uses it, and naming it there was a small lie the English told too.
  'run.armHint': 'Ενεργοποιεί πρώτα GPS και αισθητήρες — το χρονόμετρο ξεκινά στην επόμενη οθόνη.',
  'run.armHintTreadmill':
    'Ενεργοποιεί πρώτα τους αισθητήρες σου — το χρονόμετρο ξεκινά στην επόμενη οθόνη.',
  'run.noStructure': 'Χωρίς δομή',
  'run.routeShoes': 'Διαδρομή & παπούτσια',
  'run.goal.distance': 'Απόσταση',
  'run.goal.calories': 'Θερμίδες',
  'run.goal.paceHint':
    'Προαιρετικός οδηγός ρυθμού — ανεξάρτητος από τους στόχους απόστασης/χρόνου παραπάνω.',
  'run.pause': 'Παύση',
  'run.resume': 'Συνέχεια',
  'run.lap': 'Γύρος',
  'run.lapN': 'Γύρος {index}',
  'run.hrStrap': 'Ζώνη παλμών',
  'run.discardRun': 'Απόρριψη τρεξίματος',
  'run.pod.kcal': 'kcal',
  'run.pod.kcalHr': 'kcal · παλμοί',
  'run.none': 'Κανένα',
  'run.route': 'Διαδρομή',
  'run.noGhostRoute': 'Χωρίς διαδρομή-φάντασμα',

  'run.outdoorRun': 'Τρέξιμο έξω',
  'run.tapToEdit': 'Πάτα για επεξεργασία παρακάτω',
  'run.goal.targetMinutes': 'Στόχος (λεπτά)',
  'run.goal.targetKcal': 'Στόχος (kcal)',
  ...
  'run.hrInfo':
    'Οποιαδήποτε ζώνη στήθους ή ρολόι Bluetooth με την τυπική υπηρεσία καρδιακών παλμών. Σύνδεσέ την πριν ξεκινήσεις ώστε οι ζώνες και το μοντέλο θερμίδων με παλμούς να συμπεριληφθούν. Πάτα ξανά το κουμπί για αποσύνδεση.',
  'run.noWebBluetooth':
    'Αυτός ο browser δεν έχει Web Bluetooth. Το Chrome σε Android το υποστηρίζει· ο Safari όχι.',
  'settings.footpod.hint':
    'Χωρίς διόρθωση — ο αισθητήρας γίνεται πιστευτός ως έχει. Τερμάτισε ένα τρέξιμο σε διάδρομο έχοντας γράψει την απόσταση της κονσόλας και αυτό ρυθμίζεται μόνο του.',
  'settings.hc.title': 'Health Connect',
  'settings.hc.samsung': 'Samsung Health',
  'settings.hc.scan': 'Σάρωση Health Connect',
  'settings.hc.scanning': 'Σάρωση…',
  'settings.hc.importing': 'Εισαγωγή…',
  'settings.hc.androidNote':
    'Διαθέσιμο στην εγκατεστημένη εφαρμογή Android, όχι στον browser.',
  'profile.crash': 'Δεν ήταν δυνατό το άνοιγμα του Προφίλ.',
  'profile.crashDetail': 'Δεν ήταν δυνατό το άνοιγμα του Προφίλ: {detail}',
  'profile.tryAgain': 'Δοκίμασε ξανά',
  'profile.shoes.pickHint': 'Διάλεξε ζευγάρι στην οθόνη {screen} πριν ξεκινήσεις· τα χιλιόμετρα προστίθενται όταν τερματίσεις.',
  'history.startPlanHint': 'Ξεκίνα ένα πλάνο από {coach} για να βλέπεις εδώ μελλοντικές προπονήσεις.',
  'history.emptyDay': 'Τίποτα καταγεγραμμένο ή προγραμματισμένο αυτή τη μέρα.',
  'detail.noRouteRecorded': 'Δεν καταγράφηκε διαδρομή',
};
