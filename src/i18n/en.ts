...
export const en = {
  ...
  // --- Profile --------------------------------------------------------------
  'profile.defaultName': 'Runner',
  'profile.subtitle': 'Your body, zones, and shoes — all on this device.',
  'profile.lifetime': 'Lifetime mileage',
  'profile.totalUnit': '{unit} total',
  'profile.runs': 'Runs',
  'profile.longest': 'Longest',
  'profile.lifetimeHint':
    'Sum of every saved run on this device (updates when you finish or delete).',
  'profile.name': 'Name',
  'profile.namePlaceholder': 'e.g. Alex',
  'profile.birthDate': 'Date of birth',
  'profile.birthHint': 'Age is calculated automatically for max HR and calorie estimates.',
  'profile.currentAge': {
    one: 'Currently {years} year.',
    other: 'Currently {years} years.',
  },
  'profile.heightLabel': 'Height (cm)',
  'profile.heightPlaceholder': 'e.g. 175',
  'profile.clearHint': 'You can clear the field while typing — nothing is saved until Save.',
  'profile.sexLabel': 'Sex (for calorie estimate)',
  ...
  'profile.savedNamed': 'Profile saved · {name}.',
  'profile.invalidBirth': 'Enter a valid date of birth.',
  'profile.invalidHeight': 'Height must be between 80 and 250 cm.',
  'profile.currentUnit': 'Current {unit}',
  'profile.goalUnit': 'Goal {unit}',
  ...
  'profile.shoes.edit': 'Edit pair',
  'profile.shoes.brand': 'Brand (optional)',
  'profile.shoes.limit': 'Wear limit ({unit})',
  'profile.shoes.mileageHint':
    'Mileage is not changed here — it only grows when you finish runs in these shoes.',
  'profile.shoes.savePair': 'Save pair',
  'profile.shoes.saveChanges': 'Save changes',
  'profile.shoes.retire': 'Retire',
